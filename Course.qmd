...
![Dr Sinead Rocha](images/sinead-rocha.png)
:::
...
![](images/sensor-research.jpg){.absolute bottom="10" right="50" width="40%"}

## Research in society

![](images/forensic-event.jpg){.column width="30%"} ![](images/research-impact.jpg){.column width="30%"} ![](images/cold-case.jpg){.column width="30%"}
...
![](images/psych-social.jpg){.column width="30%"} ![](images/film-night1.jpg){.column width="30%"} ![](images/film-night2.jpg){.column width="30%"}
